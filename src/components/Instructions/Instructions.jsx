    ...
    return (
        <div className="instructions">
            ...
            <ul>
                ...
                <li><strong>Yellow:</strong> The letter is correct but in the wrong position.</li>
            ...
            <ul>
                <li><strong>Guesses:</strong> Changes number of guesses per round</li>
                <li><strong>Letters:</strong> Changes the number of letters in the secret word</li>
            </ul>
        </div>
    )
}